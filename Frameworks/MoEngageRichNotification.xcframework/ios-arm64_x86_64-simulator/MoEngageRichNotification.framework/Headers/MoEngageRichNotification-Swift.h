...
SWIFT_RESILIENT_CLASS("_TtC24MoEngageRichNotification39MoEngageRichNotificationDelegateHandler")
@interface MoEngageRichNotificationDelegateHandler : MoEngageRichNotificationDelegate
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (MoEngageModuleInfo * _Nonnull)getInfo SWIFT_WARN_UNUSED_RESULT;
@end
